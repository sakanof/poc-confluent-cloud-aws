...
variable "private_az1_cidr_block" {
  ...
  description   = "Private AZ A CIDR Block (default: 10.0.0.0/20)."
}

variable "private_az2_cidr_block" {
  type          = string
  default       = "10.0.64.0/20"
  description   = "Private AZ B CIDR Block (default: 10.0.16.0/20)."
}

variable "private_az3_cidr_block" {
  type          = string
  default       = "10.0.80.0/20"
  description   = "Private AZ C CIDR Block (default: 10.0.32.0/20)."
}
